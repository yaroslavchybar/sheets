    ...
    <div className="flex min-h-screen items-center justify-center bg-muted/50">
      <Card className="w-full max-w-sm">
        ...
        <CardContent className="grid gap-4">
          <Button variant="outline" onClick={() => login('member')}>
            <GoogleIcon />
            Sign in with Google
          </Button>
          <div className="text-center text-xs">
            <button onClick={() => login('admin')} className="text-muted-foreground hover:text-primary underline-offset-4 hover:underline">
              Log in as Admin
            </button>
          </div>
        </CardContent>
